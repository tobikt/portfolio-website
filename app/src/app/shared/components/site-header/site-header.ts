...
@Component({
  ...
  template: `
    <header
      class="sticky top-0 z-50 border-b border-[var(--color-border-subtle)] bg-[var(--color-bg)]/90 backdrop-blur-xl"
    >
      <div
      ...
      >
        ...
        <div class="flex flex-wrap items-center gap-3 sm:justify-end">
          <nav
            ...
            class="flex flex-wrap items-center gap-3 text-xs font-medium text-[var(--color-muted)] sm:gap-6 sm:text-sm"
          >
            ...
            >
            <a
              class="rounded-md bg-[var(--color-primary)] px-3 py-2 text-white transition-colors hover:bg-[var(--color-primary-hover)]"
              href="#contact"
              >Kontakt</a
            >
          </nav>
